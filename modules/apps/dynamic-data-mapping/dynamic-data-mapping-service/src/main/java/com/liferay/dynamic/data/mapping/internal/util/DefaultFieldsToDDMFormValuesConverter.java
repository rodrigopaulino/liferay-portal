...
@Component(
	immediate = true,
	property = {
		"ddm.form.values.converter.type=default", "service.ranking:Integer=100"
	},
	service = FieldsToDDMFormValuesConverter.class
)
public class DefaultFieldsToDDMFormValuesConverter
