 ...
 * @generated
 */
public abstract class DDMFormInstanceVersionFinderBaseImpl
	extends BasePersistenceImpl<DDMFormInstanceVersion> {

	public DDMFormInstanceVersionFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return ddmFormInstanceVersionPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DDMFormInstanceVersionFinderBaseImpl.class);
