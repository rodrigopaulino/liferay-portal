 ...
 */
public class SearchPortletFacetsConfigurationSupplier
	implements FacetsConfigurationSupplier {

	public SearchPortletFacetsConfigurationSupplier(
	...
	@Override
	public String getFacetsConfiguration() {
