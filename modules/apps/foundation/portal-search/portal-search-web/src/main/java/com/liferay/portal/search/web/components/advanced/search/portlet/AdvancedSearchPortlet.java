...
@Component(
	...
	property = {
		...
		"com.liferay.portlet.css-class-wrapper=" +
			AdvancedSearchPortletKeys.CSS_CLASS_WRAPPER,
		...
		"javax.portlet.display-name=" +
			AdvancedSearchPortletKeys.DISPLAY_NAME,
		"javax.portlet.expiration-cache=0",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=" +
			AdvancedSearchPortletKeys.VIEW_TEMPLATE,
		"javax.portlet.name=" + AdvancedSearchPortletKeys.PORTLET_NAME,
