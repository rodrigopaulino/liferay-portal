...
public class ObjectEntryUtil {
	 ...
	 * @return the matching object entries
	 */
	public static List<ObjectEntry> findByODI_U(
		long userId, long objectDefinitionId) {

		return getPersistence().findByODI_U(userId, objectDefinitionId);
	}
	...
	public static List<ObjectEntry> findByODI_U(
		...
		return getPersistence().findByODI_U(
	 ...
	 * @throws NoSuchObjectEntryException if a matching object entry could not be found
	 */
	public static ObjectEntry findByODI_U_First(
			long userId, long objectDefinitionId,
			OrderByComparator<ObjectEntry> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectEntryException {

		return getPersistence().findByODI_U_First(
	 ...
	 * @return the first matching object entry, or <code>null</code> if a matching object entry could not be found
	 */
	public static ObjectEntry fetchByODI_U_First(
		long userId, long objectDefinitionId,
		OrderByComparator<ObjectEntry> orderByComparator) {

		return getPersistence().fetchByODI_U_First(
			userId, objectDefinitionId, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectEntryException if a matching object entry could not be found
	 */
	public static ObjectEntry findByODI_U_Last(
			long userId, long objectDefinitionId,
			OrderByComparator<ObjectEntry> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectEntryException {

		return getPersistence().findByODI_U_Last(
			userId, objectDefinitionId, orderByComparator);
	}
	 ...
	 * @return the last matching object entry, or <code>null</code> if a matching object entry could not be found
	 */
	public static ObjectEntry fetchByODI_U_Last(
		long userId, long objectDefinitionId,
		OrderByComparator<ObjectEntry> orderByComparator) {

		return getPersistence().fetchByODI_U_Last(
			userId, objectDefinitionId, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectEntryException if a object entry with the primary key could not be found
	 */
	public static ObjectEntry[] findByODI_U_PrevAndNext(
			long objectEntryId, long userId, long objectDefinitionId,
			OrderByComparator<ObjectEntry> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectEntryException {

		return getPersistence().findByODI_U_PrevAndNext(
	 ...
	 * @param objectDefinitionId the object definition ID
	 */
	public static void removeByODI_U(long userId, long objectDefinitionId) {
		getPersistence().removeByODI_U(userId, objectDefinitionId);
	}
	 ...
	 * @return the number of matching object entries
	 */
	public static int countByODI_U(long userId, long objectDefinitionId) {
		return getPersistence().countByODI_U(userId, objectDefinitionId);
	}
