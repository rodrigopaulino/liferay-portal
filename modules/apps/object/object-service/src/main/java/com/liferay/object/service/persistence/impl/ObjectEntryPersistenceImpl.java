...
public class ObjectEntryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByODI_U;
	private FinderPath _finderPathWithoutPaginationFindByODI_U;
	private FinderPath _finderPathCountByODI_U;
	 ...
	 */
	@Override
	public List<ObjectEntry> findByODI_U(long userId, long objectDefinitionId) {
		return findByODI_U(
	 ...
	 */
	@Override
	public List<ObjectEntry> findByODI_U(
		long userId, long objectDefinitionId, int start, int end) {

		return findByODI_U(userId, objectDefinitionId, start, end, null);
	}
	...
	public List<ObjectEntry> findByODI_U(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByODI_U;
				finderArgs = new Object[] {userId, objectDefinitionId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByODI_U;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_ODI_U_USERID_2);

			sb.append(_FINDER_COLUMN_ODI_U_OBJECTDEFINITIONID_2);
	 ...
	 */
	@Override
	public ObjectEntry findByODI_U_First(
			long userId, long objectDefinitionId,
			OrderByComparator<ObjectEntry> orderByComparator)
		throws NoSuchObjectEntryException {

		ObjectEntry objectEntry = fetchByODI_U_First(
	 ...
	 */
	@Override
	public ObjectEntry fetchByODI_U_First(
		long userId, long objectDefinitionId,
		OrderByComparator<ObjectEntry> orderByComparator) {

		List<ObjectEntry> list = findByODI_U(
	 ...
	 */
	@Override
	public ObjectEntry findByODI_U_Last(
			long userId, long objectDefinitionId,
			OrderByComparator<ObjectEntry> orderByComparator)
		throws NoSuchObjectEntryException {

		ObjectEntry objectEntry = fetchByODI_U_Last(
			userId, objectDefinitionId, orderByComparator);
	 ...
	 */
	@Override
	public ObjectEntry fetchByODI_U_Last(
		long userId, long objectDefinitionId,
		OrderByComparator<ObjectEntry> orderByComparator) {

		int count = countByODI_U(userId, objectDefinitionId);
	 ...
	 */
	@Override
	public ObjectEntry[] findByODI_U_PrevAndNext(
		...
		try {
			...
			array[0] = getByODI_U_PrevAndNext(
				session, objectEntry, userId, objectDefinitionId,
				orderByComparator, true);

			array[1] = objectEntry;

			array[2] = getByODI_U_PrevAndNext(
				session, objectEntry, userId, objectDefinitionId,
				orderByComparator, false);
	...
	protected ObjectEntry getByODI_U_PrevAndNext(
	 ...
	 */
	@Override
	public void removeByODI_U(long userId, long objectDefinitionId) {
		for (ObjectEntry objectEntry :
				findByODI_U(
	 ...
	 */
	@Override
	public int countByODI_U(long userId, long objectDefinitionId) {
		FinderPath finderPath = _finderPathCountByODI_U;
	...
	private static final String _FINDER_COLUMN_ODI_U_USERID_2 =
		"objectEntry.userId = ? AND ";

	private static final String _FINDER_COLUMN_ODI_U_OBJECTDEFINITIONID_2 =
		"objectEntry.objectDefinitionId = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByODI_U = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByODI_U",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByODI_U = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByODI_U",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"userId", "objectDefinitionId"}, true);

		_finderPathCountByODI_U = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByODI_U",
			new String[] {Long.class.getName(), Long.class.getName()},
